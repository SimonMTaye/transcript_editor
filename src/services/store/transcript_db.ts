...
export interface TranscriptDB {
   ...
   */
  getRecentTranscriptMeta: (limit: number, offset: number) => Promise<TranscriptMeta[]>;
   ...
   */
  createTranscriptData: (meta_id: string, segments: TranscriptSegment[]) => Promise<Transcript>;
   ...
   */
  createTranscriptMeta: (title: string, file_id: string, file_url: string, file_type: file_type) => Promise<TranscriptMeta>;
